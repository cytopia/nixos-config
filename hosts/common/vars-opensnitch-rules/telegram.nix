...
let
  name = "Telegram";
  regexPath = "^/nix/store/[^/]+-telegram-desktop-.*/bin/.Telegram-wrapped$";

  ###
  ### Deny HTTP / 80 [TCP]
  ###
  mkInternetDenyHttp = name: regexPath: uid: {
    "${rulePrefix}-${name}-reject-internet-tcp-80" = {
      action = "reject";
      precedence = true;
      created = "2026-01-01T00:00:00+00:00";
      updated = "2026-01-01T00:00:00+00:00";
      name = "200      ${name} [${toString uid}] -> *:80 [TCP]  (HTTP)";
      enabled = true;
      duration = "always";
      operator = {
        type = "list";
